...
class DeleteMatchView: UIView {
    ...
    private lazy var titleLabel: UILabel = {
        let label = UILabel()
        label.text = textAPP.selectMatch
...
extension DeleteMatchView: UITableViewDataSource, UITableViewDelegate {
